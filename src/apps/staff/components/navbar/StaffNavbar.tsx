...
export default function StaffNavbar(){
    ...
    const navItems = [
        ...
        {text:"Care and Maintenance Chat", key:13, to:"/staff/care-and-maintenance-chat", roles: ["Maintenance Manager", "Maintenance Staff"]},
        ...
        {text:"Marketing Chat", key:16, to:"/staff/marketing-chat", roles: ["Retail Manager", "Sales Associate"]},
        {text:"Operational Chat", key:17, to:"/staff/operational-chat", roles: ["Ride Manager", "Ride Staff"]},
        ...
        {text:"Chat Maintenance Account", key:22, to:"/staff/maintenance-account-chat", roles: ["Ride Manager"]},
        {text:"Care and Maintenance Official Account", key:23, to:"/staff/maintenance-official-account", roles: ["Maintenance Manager"]},
        ...
        {text:"Propose New Ride", key:30, to:"/staff/propose-new-ride", roles: ["Ride Manager"]},
        {text:"Propose New Store", key:31, to:"/staff/propose-new-store", roles: ["Retail Manager"]},
        {text:"Add New Souvenir", key:32, to:"/staff/add-new-souvenir", roles: ["Retail Manager"]},
        {text:"Add New Maintenance", key:33, to:"/staff/add-new-maintenance", roles: ["Maintenance Manager"]},
    ]
