...
const OperationalChat: React.FC = () => {
    ...
    useEffect(() => {
        const fetchInitialMessages = async () => {
            try {
                const initialMessages = await invoke<Message[]>('fetch_new_messages', { group: "Operational" });
        ...
        const startPolling = () => {
            pollingRef.current = setInterval(async () => {
                try {
                    const newMessages = await invoke<Message[]>('fetch_new_messages', { group: "Operational" });
...
export default OperationalChat;