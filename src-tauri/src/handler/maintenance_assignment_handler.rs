...
pub fn complete_maintenance_assignment(conn: &mut DbConnect, selected_id:i32) -> Result<(), String> {
    MaintenanceAssignment::change_assignment_status(conn, selected_id, "Completed".to_string())
}
